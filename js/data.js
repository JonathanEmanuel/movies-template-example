const peliculas = [
    {
        "id": 1,
        "titulo": "Superman",
        "portada": "assets/movies/superman.jpg",
        ...
        "director": "James Gunn",
        "duracion": 129,
        "trailer": "https://www.youtube.com/watch?v=KWoJAz9YiPc",
        "genero": [
            "Ciencia Ficción",
            "Acción"
        ]
    ...
    {
        "id": 11,
        "titulo": "Desde adentro",
        "portada": "assets/movies/desde-adentro.jpg",
        "descripcion": "Sofía es una ex corredora profesional que acaba trabajando como mula para un cartel de drogas. Cuando ella y su mejor amiga son emboscadas por dos policías corruptos que quieren matarlos y tomar las drogas, se desatará el infierno cuando descubran que lo que llevaban no es de este mundo. Ahora le toca a Doc, un sicario del cartel y amante de Sofía, salvar sus vidas.",
        "estreno": 2025,
        "director": "Matías Rispau",
        "duracion": 116,
        "trailer": "https://www.youtube.com/watch?v=wk2QkjmxU9A",
        "genero": [
            "Acción",
            "Terror",
            "Ciencia Ficción"
    ...
    },
    {
        "id": 20,
        "titulo": "Spectral",
        "portada": "assets/movies/spectral.jpg",
        "descripcion": "Esta historia de ciencia ficción / thriller se centra en un equipo de operaciones especiales enviado para luchar contra unos seres sobrenaturales.",
        "estreno": 2016,
